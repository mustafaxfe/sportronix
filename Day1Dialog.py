...
# Form implementation generated from reading ui file 'Day1Dialog.ui'
#
...
import Day2Dialog, Day3Dialog
import json, user_choice_dialog, sys
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(658, 440)
        self.idNum = "3456"
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, -10, 2, 2))
        self.layoutWidget.setObjectName("layoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.layoutWidget_2 = QtWidgets.QWidget(Dialog)
        self.layoutWidget_2.setGeometry(QtCore.QRect(0, -10, 2, 2))
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.layoutWidget_2)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.layoutWidget_3 = QtWidgets.QWidget(Dialog)
        self.layoutWidget_3.setGeometry(QtCore.QRect(0, -10, 2, 2))
        ...
        self.layoutWidget_4.setGeometry(QtCore.QRect(340, 10, 137, 301))
        ...
        self.pushButton_3.clicked.connect(self.day3_clicked)
        self.verticalLayout_2.addWidget(self.pushButton_3)
        self.scrollArea = QtWidgets.QScrollArea(Dialog)
        self.scrollArea.setGeometry(QtCore.QRect(10, 10, 321, 291))
    ...
    def day2_clicked(self):
        ...
        Dialog.showFullScreen()
        sys.exit(Dialog.exec_())
    def day3_clicked(self):
        app = QtWidgets.QApplication(sys.argv)
        Dialog = QtWidgets.QDialog()
        ui = Day3Dialog.Ui_Dialog()
        ui.setupUi(Dialog)
        Dialog.showFullScreen()
        sys.exit(Dialog.exec_())
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_2.setText(_translate("Dialog", "2. Gün"))
        self.pushButton_3.setText(_translate("Dialog", "3. Gün"))
        self.groupBox.setTitle(_translate("Dialog", "1. Günün Programı"))
        ...
        if "Day1" in self.omuzDict[self.idNum]:
            self.milPress.setText("Set/Tekrar" + self.omuzDict[self.idNum]["Day1"]["Military Press"])
            self.label_4.setText("Set/Tekrar" + self.omuzDict[self.idNum]["Day1"]["Literal Press"])
            self.overPress.setText("Set/Tekrar" + self.omuzDict[self.idNum]["Day1"]["Overhead Press"])
            self.seatPress.setText("Set/Tekrar" + self.omuzDict[self.idNum]["Day1"]["Seated Dumbell Press"])
        ...
        if "Day1" in self.bicepsDict[self.idNum]:
            self.hamCurl.setText("Set/Tekrar" + self.bicepsDict[self.idNum]["Day1"]["Hammer Curl"])
            self.babDumbell.setText("Set/Tekrar" + self.bicepsDict[self.idNum]["Day1"]["Babell Curl"])
            self.incDumbel.setText("Set/Tekrar" + self.bicepsDict[self.idNum]["Day1"]["Incline Dumbell"])
        else:
            self.hamCurl.setText("Bugun Yok")
            self.babDumbell.setText("Bugun Yok")
            self.incDumbel.setText("Bugun Yok")
        if "Day1" in self.bacakDict[self.idNum]:
            self.squat_label.setText("Set/Tekrar" + self.bacakDict[self.idNum]["Day1"]["Squat"])
            self.labExe.setText("Set/Tekrar" + self.bacakDict[self.idNum]["Day1"]["Lab execution"])
        else:
            self.squat_label.setText("Bugun Yok")
            self.labExe.setText("Bugun Yok")
        if "Day1" in self.gogusDict[self.idNum]:
            self.bench_2.setText("Set/Tekrar" + self.gogusDict[self.idNum]["Day1"]["Bench Press"])
            self.cableCro.setText("Set/Tekrar" + self.gogusDict[self.idNum]["Day1"]["Cable Cross"])
            self.dumbellFlu.setText("Set/Tekrar" + self.gogusDict[self.idNum]["Day1"]["Dumbell Cross"])
        else:
            self.bench_2.setText("Bugun Yok")
            self.cableCro.setText("Bugun Yok")
            self.dumbellFlu.setText("Bugun Yok")
        if "Day1" in self.triceptDict[self.idNum]:
            self.dips.setText("Set/Tekrar" + self.triceptDict[self.idNum]["Day1"]["Dips"])
            self.skull.setText("Set/Tekrar" + self.triceptDict[self.idNum]["Day1"]["Skull Crossers"])
        else:
            self.dips.setText("Bugun Yok")
            self.skull.setText("Bugun Yok")
        if "Day1" in self.torbaDict[self.idNum]:
            self.torba_2.setText(_translate("Form", "2li 3lü yumruklar"))
        else:
            self.torba_2.setText("Bugün Yok")
        if "Day1" in self.sirtDict[self.idNum]:
            self.Barfiks_2.setText("Set/Tekrar" + self.triceptDict[self.idNum]["Day1"]["Barfiks"])
            self.dead.setText("Set/Tekrar" + self.triceptDict[self.idNum]["Day1"]["Dead Lift"])
            self.label_23.setText("Set/Tekrar" + self.triceptDict[self.idNum]["Day1"]["T Bar Row"])
